...
import org.jetbrains.jewel.components.tree.Tree
import org.jetbrains.jewel.components.tree.TreeComposable
import org.jetbrains.jewel.components.tree.asTree
import org.jetbrains.jewel.components.tree.handleKeyEventOnTree
                ...
                Surface {
                    ...
                    Box {
                        ...
                        TreeComposable(
                            ...
                            tree = tree,
                            onElementClick = {
                                        println("clicked ${it.data.absolutePath}")
                            },
                            onElementDoubleClick = {
                                        println("doubleClicked ${it.data.absolutePath}")
                            } ,
                            onElementFocus = {
                                println("element focussed ${it.data.absolutePath}")
                            } ,
                            onKeyEventHandler = { ke, list, element ->
                                ke.handleKeyEventOnTree(tree, list, element) { println("element selection via KeyEvent -> $${it.data.name}") }
                            },
                            elementContent = {
...
//import org.jetbrains.jewel.components.Text
//import org.jetbrains.jewel.components.tree.Tree
//import org.jetbrains.jewel.components.tree.TreeLayout
//import org.jetbrains.jewel.components.tree.asTree
//import org.jetbrains.jewel.themes.darcula.idebridge.IntelliJTheme
//import org.jetbrains.jewel.themes.darcula.idebridge.addComposePanel
//import java.nio.file.Paths
